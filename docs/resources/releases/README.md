...
| 0.5.0-operational-coherence | Released | 2026-07-11 | `v0.5.0-operational-coherence` observed at `2841f02` | `docs/resources/evolution/0.5.0-operational-coherence-execution-log.md` | 0.4.0-verification-first | N/A | `docs/resources/releases/0.5.0-operational-coherence-migration.md` |
